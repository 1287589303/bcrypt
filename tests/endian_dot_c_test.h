...
extern "C" void getEndian_endian_c(unsigned char **e);
static void getEndian(unsigned char **e) {
getEndian_endian_c(e);
}
extern "C" uInt32 swapEndian_endian_c(uInt32 value);
static uInt32 swapEndian(uInt32 value) {
return swapEndian_endian_c(value);
}
extern "C" int testEndian_endian_c(char *input);
static int testEndian(char *input) {
return testEndian_endian_c(input);
}
extern "C" int swapCompressed_endian_c(char **input, uLong sz);
static int swapCompressed(char **input, uLong sz) {
return swapCompressed_endian_c(input, sz);
}
