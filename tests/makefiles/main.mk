...
bin : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_shared.mk bin
build : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_shared.mk build || $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_obj.mk build
run : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_shared.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_shared.mk run; exit $$?; } || { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_obj.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_obj.mk run; exit $$?; } }
clean : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_shared.mk clean
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__main_obj.mk clean
