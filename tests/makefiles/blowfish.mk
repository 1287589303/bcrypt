...
ifndef UTBOT_ALL
    export UTBOT_ALL = $(PROJECT_DIR)/utbot-release-2024.3.0/utbot_distr
endif
...
ifneq ("$(wildcard $(UTBOT_INSTALL)/bin/clang-14)\", "")
    export CLANG = $(UTBOT_INSTALL)/bin/clang-14
endif
...
bin : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_shared.mk bin
build : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_shared.mk build || $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_obj.mk build
run : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_shared.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_shared.mk run; exit $$?; } || { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_obj.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_obj.mk run; exit $$?; } }
clean : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_shared.mk clean
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__blowfish_obj.mk clean
