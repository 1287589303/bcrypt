...
bin : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_shared.mk bin
build : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_shared.mk build || $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_obj.mk build
run : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_shared.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_shared.mk run; exit $$?; } || { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_obj.mk build && { $(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_obj.mk run; exit $$?; } }
clean : .FORCE
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_shared.mk clean
	$(MAKE) -f $(PROJECT_DIR)/tests/makefiles/__wrapbf_obj.mk clean
