...
extern "C" uLong BFEncrypt_wrapbf_c(char **input, char *key, uLong sz, BCoptions *options);
static uLong BFEncrypt(char **input, char *key, uLong sz, BCoptions *options) {
return BFEncrypt_wrapbf_c(input, key, sz, options);
}
extern "C" uLong BFDecrypt_wrapbf_c(char **input, char *key, char *key2, uLong sz, BCoptions *options);
static uLong BFDecrypt(char **input, char *key, char *key2, uLong sz, BCoptions *options) {
return BFDecrypt_wrapbf_c(input, key, key2, sz, options);
}
