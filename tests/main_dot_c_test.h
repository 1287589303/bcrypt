...
extern "C" BCoptions initoptions_main_c(BCoptions options);
static BCoptions initoptions(BCoptions options) {
return initoptions_main_c(options);
}
extern "C" int usage_main_c(char *name);
static int usage(char *name) {
return usage_main_c(name);
}
extern "C" int memerror_main_c();
static int memerror() {
return memerror_main_c();
}
extern "C" int parseArgs_main_c(int *argc, char **argv, BCoptions *options);
static int parseArgs(int *argc, char **argv, BCoptions *options) {
return parseArgs_main_c(argc, argv, options);
}
extern "C" int assignFiles_main_c(char *arg, char **infile, char **outfile, struct stat *statbuf, BCoptions *options, char *key);
static int assignFiles(char *arg, char **infile, char **outfile, struct stat *statbuf, BCoptions *options, char *key) {
return assignFiles_main_c(arg, infile, outfile, statbuf, options, key);
}
