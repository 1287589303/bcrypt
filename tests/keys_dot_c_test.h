...
extern "C" char *getkey_keys_c(int type);
static char *getkey(int type) {
return getkey_keys_c(type);
}
extern "C" void mutateKey_keys_c(char **key, char **key2);
static void mutateKey(char **key, char **key2) {
mutateKey_keys_c(key, key2);
}
