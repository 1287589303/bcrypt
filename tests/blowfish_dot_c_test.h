...
extern "C" ORIG_P_pointer get_pointer_to_ORIG_P_blowfish_c();
const uInt32 (&ORIG_P)[18] = *get_pointer_to_ORIG_P_blowfish_c();
typedef const uInt32 (*ORIG_S_pointer)[4][256];
extern "C" ORIG_S_pointer get_pointer_to_ORIG_S_blowfish_c();
const uInt32 (&ORIG_S)[4][256] = *get_pointer_to_ORIG_S_blowfish_c();
extern "C" uInt32 F_blowfish_c(BLOWFISH_CTX *ctx, uInt32 x);
static uInt32 F(BLOWFISH_CTX *ctx, uInt32 x) {
return F_blowfish_c(ctx, x);
}
extern "C" void Blowfish_Encrypt_blowfish_c(BLOWFISH_CTX *ctx, uInt32 *xl, uInt32 *xr);
static void Blowfish_Encrypt(BLOWFISH_CTX *ctx, uInt32 *xl, uInt32 *xr) {
Blowfish_Encrypt_blowfish_c(ctx, xl, xr);
}
extern "C" void Blowfish_Decrypt_blowfish_c(BLOWFISH_CTX *ctx, uInt32 *xl, uInt32 *xr);
static void Blowfish_Decrypt(BLOWFISH_CTX *ctx, uInt32 *xl, uInt32 *xr) {
Blowfish_Decrypt_blowfish_c(ctx, xl, xr);
}
extern "C" void Blowfish_Init_blowfish_c(BLOWFISH_CTX *ctx, unsigned char *key, int keyLen);
static void Blowfish_Init(BLOWFISH_CTX *ctx, unsigned char *key, int keyLen) {
Blowfish_Init_blowfish_c(ctx, key, keyLen);
}
