...
extern "C" uLong docompress_wrapzl_c(char **input, uLong sz);
static uLong docompress(char **input, uLong sz) {
return docompress_wrapzl_c(input, sz);
}
extern "C" uLong douncompress_wrapzl_c(char **input, uLong sz, BCoptions options);
static uLong douncompress(char **input, uLong sz, BCoptions options) {
return douncompress_wrapzl_c(input, sz, options);
}
